...
objects = list.o parselvl.o fsm.o geometry.o sprite.o ledge.o enemy.o player.o text.o texture.o scaffold.o menustate.o playstate.o pausestate.o gameoverstate.o
