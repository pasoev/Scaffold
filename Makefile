...
CFLAGS=-I/usr/include/libxml2 -lSDL2 -lSDL2_image -lSDL2_gfx -lSDL2_ttf -lm -g $(W) -lxml2 
objects = list.o parselvl.o fsm.o geometry.o sprite.o ledge.o player.o text.o texture.o scaffold.o menustate.o playstate.o pausestate.o gameoverstate.o
